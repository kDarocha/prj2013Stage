<?php // $Id: node.tpl.php,v 1.2 2010/05/27 18:57:51 btopro Exp $
/**
 * @file
 *  node.tpl.php
 *
    ...
    <div class="node-inner-1">
      <div class="node-inner-2">
        <div class="node-inner-3">
          ...
          <?php endif; ?>
          <?php if (theme_get_setting('chamfer_taxonomy') != 0 && $terms): ?>
          <div class="taxonomy"><?php print t('Posted in ') . $terms; ?></div>
          <?php endif; ?>
          <div class="content clearfix"><?php print $content; ?></div>
          <?php if ($links): ?><div class="actions clearfix"><?php print $links; ?></div><?php endif; ?>
        </div>
      </div>
    </div>
  </div>
